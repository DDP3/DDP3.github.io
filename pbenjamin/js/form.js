...
function display(event) {
	...
	var Person = {
		nameFirst: form.firstname.value,
		nameLast: form.lastname.value,
	...
	var html = "<p>You typed: " + Person.nameFirst + " and " + Person.nameLast + "and your password was " + Person.password + "</p>" ;
